...
Radar also exposes public API endpoints that anyone can integrate, without authentication:
...
<Note>
Radar API is public and free to integrate in your own tools, dashboards, and automations.
</Note>
