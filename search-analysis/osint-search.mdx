...
Provider coverage depends on your plan. Standard queries a base set of providers. Pro and Ultimate unlock additional sources, including premium breach databases and extra leak providers. For full pricing details, see [osint.ly/pricing](https://osint.ly/pricing).
 

| Capability | Standard | Pro | Ultimate |
|---|---:|---:|---:|
...
| Security Watch / legacy Monitoring | No | See current product availability | See current product availability |
| Organization members | — | Plan and paid seats determine access | Plan and paid seats determine access |
...
Full app searches are saved automatically in the workspace selected when they launch. Access them at [osint.ly/history](https://osint.ly/history). Personal history stays private; organization history is shared with the organization’s members and identifies the creator. Free previews are temporary and do not appear there.
