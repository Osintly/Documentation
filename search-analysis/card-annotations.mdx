...
Card Annotations lets you tag and add notes to individual search results, transforming raw findings into actionable intelligence. The real-time Team annotation flow described here applies to legacy Team projects.

<Note>
Organization searches are shared through organization history. Organization-scoped projects and annotation collaboration are not yet available.
</Note>

<Note>
This feature is available on full result pages across paid app plans. Limited free previews do not include annotations.
</Note>
...
<Note>
Legacy Team collaboration requires an active Team workspace. See [Organizations & workspaces](/collaboration/organizations) for the current shared-workspace model.
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Organizations & workspaces" icon="buildings" href="/collaboration/organizations">
    Understand the current shared-workspace model and its data boundaries.
  </Card>
</CardGroup>
