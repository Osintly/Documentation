...
<AccordionGroup>
  ...
  <Accordion title="Does Osintly store my searches?" icon="database">
    Full searches are stored in your account history at [osint.ly/history](https://osint.ly/history). You can delete individual entries or select multiple entries for bulk deletion. Free previews are temporary, are not linked to account history, and expire after 15 minutes.
  </Accordion>
</AccordionGroup>
