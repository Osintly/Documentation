...
This means the deletion has been accepted for asynchronous processing. Your application should treat the request as queued work rather than an immediate hard delete confirmation.
