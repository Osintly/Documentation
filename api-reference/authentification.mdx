...
Most API endpoints require a bearer token in the `Authorization` header. `GET /health` is public; `GET /`, Search, Tools, Radar, Modules, and Usage require a valid key.
