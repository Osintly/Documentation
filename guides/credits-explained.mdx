...
Full app searches cost credits; limited [free search previews](/guides/free-searches) use a separate quota. This page explains credit spending, expiry, and balances.
...
**Promotional or free credits** may have an expiration date. When they do, the terms of the promotion specify the deadline. Check [osint.ly/terms](https://osint.ly/terms#credits) for full details.
...
<AccordionGroup>
  <Accordion title="Any new search query" icon="magnifying-glass">
    Running a supported full app search costs 1 credit per query.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Exporting results" icon="file-export">
    Exporting an existing result to PDF, JSON, CSV, or Markdown does not consume credits. The available formats depend on your plan and the current result interface.
  </Accordion>
  ...
  <Accordion title="Free previews" icon="gift">
    Limited pseudonym and email previews do not use app credits. They have separate hourly and daily quotas and are not saved in your history. See [Free search previews](/guides/free-searches).
  </Accordion>
</AccordionGroup>
...
If your balance reaches 0, full searches are unavailable until credits are restored. You may still be able to run a limited free preview under its separate quota. Your history and existing results remain accessible.
