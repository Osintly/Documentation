...
<AccordionGroup>
  ...
  <Accordion title="Export" icon="file-export">
    Export the full result set as PDF, JSON, CSV, or Markdown. Individual card modals offer JSON; the map offers CSV and JSON. DOCX is not currently offered in the result export menu.
  </Accordion>
  <Accordion title="Collaborate" icon="users">
    Link a result to a legacy Team project for its existing collaboration flow. In an organization, searches are instead visible to organization members in shared history; organization projects are not yet available.
  </Accordion>
