...
<Steps>
  ...
  <Step title="Pivot between identifiers">
    Layer supported searches from username to email, then inspect any discovered IP in [IP Intelligence](/tools-reference/ip-intelligence). Treat each association as a lead to verify, not proof of identity.
  </Step>
  ...
  <Step title="Generate a timeline with AI Analyst">
    ...
    <Note>AI Analyst is available on Pro and Ultimate plans.</Note>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Pivot to the domain">
    If the email uses a custom domain rather than Gmail or Outlook, inspect it with [Domain Intelligence](/tools-reference/domain-intelligence).
  </Step>
</Steps>
...
<Steps>
  <Step title="Start with the domain">
    Open [Domain Intelligence](/tools-reference/domain-intelligence) and enter the root domain. Review DNS records, subdomains, registration data, and linked IPs.
  </Step>
  <Step title="Pivot to each IP">
    Inspect relevant IPs in [IP Intelligence](/tools-reference/ip-intelligence). Check ASN, hosting provider, approximate geolocation, and public threat signals.
  </Step>
  ...
  <Step title="Preserve a repeatable follow-up">
    Save the search in the correct workspace and repeat focused domain or IP checks when you need fresh DNS, subdomain, or IP data.

    <Note>The current Monitoring experience is being retired in favor of Security Watch. Avoid creating new monitors.</Note>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Monitor for changes">
    Save the domain investigation and repeat focused checks to track infrastructure changes, new subdomains, or data-leak appearances while Security Watch is prepared.
  </Step>
  <Step title="Export a report">
    Use **Export to PDF** or another currently offered format (JSON, CSV, or Markdown) to produce a deliverable for internal review or legal counsel.
